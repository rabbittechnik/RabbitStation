...
export const FEATURE_MIN_PLAN: Record<FeatureKey, 'starter' | 'pro' | 'multi_station'> = {
  ...
  holidays: 'starter',
  payroll_schedule: 'starter',
  protected_documents: 'pro',
  time_tracking: 'pro',
  time_approvals: 'pro',
  payroll_time_tracking: 'pro',
  payroll_audit: 'pro',
  surcharges: 'pro',
  absences: 'pro',
...
export const FEATURE_LABELS: Partial<Record<FeatureKey, string>> = {
  payroll_schedule: 'Lohnabrechnung (Schichtplan)',
  payroll_time_tracking: 'Lohnabrechnung (Zeiterfassung)',
...
export const NAV_PATH_FEATURES: Record<string, FeatureKey> = {
  ...
  '/reports/payroll-time': 'payroll_time_tracking',
  '/reports/payroll-schedule': 'payroll_schedule',
