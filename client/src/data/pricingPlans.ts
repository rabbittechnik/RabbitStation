...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    features: [
      ...
      { text: 'Zeiterfassung', included: false },
      { text: 'Lohnprüfung', included: false },
      { text: 'Zuschlagsauswertung', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Lohnprüfung', included: true },
      { text: 'Zuschlagsauswertung', included: true },
      ...
      { text: 'Monatsübersichten', included: true },
    ],
  },
  {
    id: 'multi_station',
