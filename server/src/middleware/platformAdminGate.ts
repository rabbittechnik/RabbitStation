...
const CC_WRITE_PATH =
  /^\/api\/admin\/(tenants\/[^/]+\/support-sessions\/start|support-sessions\/[^/]+\/end|tenants\/[^/]+\/subscription|tenants\/[^/]+\/trial\/extend|tenants\/[^/]+\/users\/[^/]+\/resend-welcome-email|mail\/test|backups\/create)$/
